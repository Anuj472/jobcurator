...
export const INITIAL_COMPANIES = [
  ...
  { name: "Datadog", identifier: "datadog", platform: AtsPlatform.GREENHOUSE },
  { name: "Zoom", identifier: "zoom-video-communications", platform: AtsPlatform.GREENHOUSE },
  { name: "Square (Block)", identifier: "block", platform: AtsPlatform.GREENHOUSE },
  ...
  // ========== NEW CONSUMER & MEDIA ==========
  { name: "Spotify", identifier: "spotify", platform: AtsPlatform.LEVER },
  ...
  { name: "Zepto", identifier: "zeptonow", platform: AtsPlatform.LEVER },
  ...
  { name: "PharmEasy", identifier: "pharmeasy", platform: AtsPlatform.GREENHOUSE },
  { name: "Urban Company", identifier: "urbanclap", platform: AtsPlatform.GREENHOUSE },
